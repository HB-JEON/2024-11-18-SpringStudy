                    ...
                    <nav class="navbar navbar-expand-lg">
                        ...
                        <div class="collapse navbar-collapse justify-content-center" id="yummyfood-nav">
                            <ul class="navbar-nav" id="yummy-nav">
                                ...
                                <li class="nav-item dropdown">
                                    <a class="nav-link dropdown-toggle" href="#" id="yummyDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">부산 여행</a>
                                    <div class="dropdown-menu" aria-labelledby="yummyDropdown">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="../movie/movie_list.do">Open API</a>
                                </li>
                                <c:if test="${sessionScope.userid!=null }">
                                </c:if>
                               ...
                               <sec:authorize access="hasRole('ROLE_ADMIN')">
                                <li class="nav-item">
                                    <a class="nav-link" href="../adminpage/reserve_list.do">관리자 페이지</a>
                                </li>
                               </sec:authorize>
                            </ul>
                        </div>
