                  ...
                  <table class="table">
                    ...
                    <c:forEach var="vo" items="${list }">
                      <tr>
                        ...
                        <td class="text-center">
                          <input type="button" value="구매" class="btn-sm btn-success" @click="buy(${vo.cno },'${vo.gvo.goods_name}','${vo.gvo.goods_price}')">
                          <a href="../mypage/cart_cancel.do?cno=${vo.cno }" class="btn-sm btn-info">삭제</a>
                        </td>
                      </tr>
                    </c:forEach>
                  </table>
