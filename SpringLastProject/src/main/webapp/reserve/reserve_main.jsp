              ...
              <div class="col-12 col-lg-12">
                <div class="row no-gutters">
                  <table class="table">
                    <tr>
                          ...
                          <table class="table">
                            ...
                            <tr v-for="vo in food_list" class="food-click" @click="foodSelect(vo.fno, vo.poster, vo.name)">
                              <td class="text-center">
                                <img :src="'https://www.menupan.com'+vo.poster" style="widows: 35px; height: 35px;">
                              </td>
                              <td>{{vo.name}}</td>
                            </tr>
                          </table>
                      ...
                      <td width="35%" height="500" rowspan="2">
                        <table class="table">
                          ...
                          <tr>
                            <th width="40%" class="text-center">예약 시간</th>
                            <td width="60%">{{time}}</td>
                          </tr>
                          <tr>
                            <th width="40%" class="text-center">예약 인원</th>
                            <td width="60%">{{inwon}}</td>
                          </tr>
                          <tr v-show="isReserveBtn">
                            <td colspan="2" class="text-center">
                              <button class="btn-lg btn-primary" @click="reserve()">예약하기</button>
                            </td>
                          </tr>
                        </table>
                      </td>
                    ...
                    <tr>
                    <td width="30%" height="150" rowspan="2">
                        <table class="table">
                          <tr>
                            <td colspan="2">
                              <h4>시간 정보</h4>
                          ...
                          <tr v-show="isTime">
                            <td class="text-center">
                              <span class="btn btn-xs btn-success" v-for="t in time_list" style="margin: 2px" @click="timeSelect(t)">
                                {{t}}
                              </span>
                            </td>
                          </tr>
                      ...
                      <td width="35%" height="150">
                        <table class="table">
                          ...
                          <tr v-show="isInwon">
                            <td class="text-center">
                              <span class="btn btn-xs btn-danger" v-for="i in inwon_list" style="margin-left: 2px;" @click="inwonSelect(i)">
                                {{i}}
                              </span>
                            </td>
                          </tr>
