  ...
  <div class="container">
   ...
   <table class="table">
     <tr>
      <th width=15%>이름</th>
      <td width=85%>
       <input type=text name=name size=20 required class="input-sm" ref="name" v-model="name">
      </td>
     </tr>
     <tr>
      <th width=15%>제목</th>
      <td width=85%>
       <input type=text name=subject size=50 required class="input-sm" ref="subject" v-model="subject">
      </td>
     </tr>
     <tr>
      <th width=15%>내용</th>
      <td width=85%>
       <textarea rows="5" cols="52" name=content required ref="content" v-model="content"></textarea>
      </td>
     </tr>
     <tr>
       <th width="15%">첨부 파일</th>
       <th width="85%">
     ...
     <tr>
      <th width=15%>비밀번호</th>
      <td width=85%>
       <input type=password name=pwd size=10 required class="input-sm" ref="pwd" v-model="pwd">
      </td>
     </tr>
     <tr>
