...
<%--
      1. 형식
          ...
          => HTML 제어
              => v-model / v-show / v-for / v-if, v-else 
              v-bind(속성에 변수값 첨부)
               :src / :href / :title...
 --%>
<!DOCTYPE html>
...
<body>
  ...
  <div class="row">
    ...
    <div v-else="type===0">선택이 없습니다.</div>
  </div>
  </div>
  <%--
        JDBC => MyBatis => JPA
  ...
  <div class="container" id="app2">
    <input type="button" value="로그인" class="btn-sm btn-success" @click="isLogin()">
