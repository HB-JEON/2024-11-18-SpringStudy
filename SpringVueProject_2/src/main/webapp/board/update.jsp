  ...
  <div class="container">
    <div class="row">
     ...
     <tr>
      <th width="15%">이름</th>
      <td width="85%">
       <input type="text" ref="name" size="20" v-model="name" class="input-sm">
      </td>
     </tr>
     <tr>
      <th width="15%">제목</th>
      <td width="85%">
       <input type="text" ref="subject" size="50" v-model="subject" class="input-sm">
      </td>
     </tr>
     <tr>
      <th width="15%">내용</th>
     ...
     <tr>
      <th width="15%">비밀번호</th>
      <td width="85%">
       <input type="password" ref="pwd" size="10" v-model="pwd" class="input-sm">
      </td>
     </tr>
     <tr>
       <td colspan="2" align=center>
         <input type="button" value="수정" class="btn-sm btn-danger" @click="update()">
